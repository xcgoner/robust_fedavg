...
watchfile=/homes/cx2/federated/results/exp_script_6.log


logfile=/homes/cx2/federated/results/exp_balanced_lr_10_reg_010_labelflip_2_mean.txt

> $logfile

cat $PBS_NODEFILE | uniq > $PBS_O_WORKDIR/hostfile
mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile python /homes/cx2/federated/robust_fedavg/train_cifar100_mxnet_mobilenet_reg_fed_robust_impl2.py --classes 10 --model default --nsplit 100 --batchsize 50 --nbyz 2 --lr 0.1 --lr-decay 0.4 --lr-decay-epoch 400 --regularization 0.01 --reg-inc 0.1 --reg-inc-epoch 0 --epochs 800 --iterations 1 --seed 733 --dir $inputdir --valdir $valdir -o $logfile 2>&1 | tee $watchfile
cat $PBS_NODEFILE | uniq > $PBS_O_WORKDIR/hostfile
...
# cat $PBS_NODEFILE | uniq > $PBS_O_WORKDIR/hostfile
# mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile python /homes/cx2/federated/robust_fedavg/train_cifar100_mxnet_mobilenet_reg_fed_robust_impl2.py --classes 10 --model default --nsplit 100 --batchsize 50 --trim 2 --nbyz 2 --lr 0.1 --lr-decay 0.4 --lr-decay-epoch 400 --regularization 0.01 --reg-inc 0.1 --reg-inc-epoch 0 --epochs 800 --iterations 1 --seed 557 --dir $inputdir --valdir $valdir -o $logfile 2>&1 | tee $watchfile
# cat $PBS_NODEFILE | uniq > $PBS_O_WORKDIR/hostfile
# mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile python /homes/cx2/federated/robust_fedavg/train_cifar100_mxnet_mobilenet_reg_fed_robust_impl2.py --classes 10 --model default --nsplit 100 --batchsize 50 --trim 2 --nbyz 2 --lr 0.1 --lr-decay 0.4 --lr-decay-epoch 400 --regularization 0.01 --reg-inc 0.1 --reg-inc-epoch 0 --epochs 800 --iterations 1 --seed 446 --dir $inputdir --valdir $valdir -o $logfile 2>&1 | tee $watchfile



logfile=/homes/cx2/federated/results/exp_balanced_lr_10_reg_010_labelflip_2_trim_2.txt
...
logfile=/homes/cx2/federated/results/exp_balanced_lr_10_reg_010_labelflip_2_trim_4.txt

> $logfile

cat $PBS_NODEFILE | uniq > $PBS_O_WORKDIR/hostfile
mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile python /homes/cx2/federated/robust_fedavg/train_cifar100_mxnet_mobilenet_reg_fed_robust_impl2.py --classes 10 --model default --nsplit 100 --batchsize 50 --trim 4 --nbyz 2 --lr 0.1 --lr-decay 0.4 --lr-decay-epoch 400 --regularization 0.01 --reg-inc 0.1 --reg-inc-epoch 0 --epochs 800 --iterations 1 --seed 733 --dir $inputdir --valdir $valdir -o $logfile 2>&1 | tee $watchfile
cat $PBS_NODEFILE | uniq > $PBS_O_WORKDIR/hostfile
mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile python /homes/cx2/federated/robust_fedavg/train_cifar100_mxnet_mobilenet_reg_fed_robust_impl2.py --classes 10 --model default --nsplit 100 --batchsize 50 --trim 4 --nbyz 2 --lr 0.1 --lr-decay 0.4 --lr-decay-epoch 400 --regularization 0.01 --reg-inc 0.1 --reg-inc-epoch 0 --epochs 800 --iterations 1 --seed 337 --dir $inputdir --valdir $valdir -o $logfile 2>&1 | tee $watchfile
cat $PBS_NODEFILE | uniq > $PBS_O_WORKDIR/hostfile
mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile python /homes/cx2/federated/robust_fedavg/train_cifar100_mxnet_mobilenet_reg_fed_robust_impl2.py --classes 10 --model default --nsplit 100 --batchsize 50 --trim 4 --nbyz 2 --lr 0.1 --lr-decay 0.4 --lr-decay-epoch 400 --regularization 0.01 --reg-inc 0.1 --reg-inc-epoch 0 --epochs 800 --iterations 1 --seed 755 --dir $inputdir --valdir $valdir -o $logfile 2>&1 | tee $watchfile
...
logfile=/homes/cx2/federated/results/exp_balanced_lr_10_reg_010_nobyz_trim_4.txt
