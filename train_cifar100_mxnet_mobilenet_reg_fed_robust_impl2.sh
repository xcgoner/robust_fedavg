...
mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile python /homes/cx2/federated/robust_fedavg/train_cifar100_mxnet_mobilenet_reg_fed_robust_impl2.py --classes 10 --model default --nsplit 100 --batchsize 50 --lr 0.15 --lr-decay 0.2 --lr-decay-epoch 200 --regularization 0.2 --reg-inc 0.1 --reg-inc-epoch 6000 --epochs 400 --iterations 1 --dir /homes/cx2/datasets/cifar10_normalized -o $logfile 2>&1 | tee /homes/cx2/federated/results/train_cifar100_mxnet_default_reg_fed_robust_impl2.log