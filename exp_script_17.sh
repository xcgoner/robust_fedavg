    ...
    do
        ...
        do
            ...
            do 
                ...
                mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile17 python /homes/cx2/federated/fedrob/fedrob.py --classes 10 --model default --nsplit 100 --batchsize 50 --nbyz 0 --lr ${lr} --alpha ${alpha} --alpha-decay 1 --alpha-decay-epoch 400 --epochs 800 --iterations ${iteration} --seed ${seed} --dir $inputdir --valdir $valdir --log $logfile 2>&1 | tee $watchfile
            done
        done
    done
done
