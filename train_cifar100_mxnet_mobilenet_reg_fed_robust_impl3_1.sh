...
logfile=/homes/cx2/federated/results/train_cifar100_mxnet_cifarresnet_reg_fed_robust_impl3_1.txt

> $logfile

mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile python /homes/cx2/federated/robust_fedavg/train_cifar100_mxnet_mobilenet_reg_fed_robust_impl3.py --classes 10 --model cifar_resnet20_v1 --nsplit 100 --batchsize 50 --lr 0.1 --lr-decay 0.5 --lr-decay-epoch 200 --reg-factor 0.01 --reg-epsilon 800 --epochs 800 --iterations 5 --dir /homes/cx2/datasets/cifar10 -o $logfile 2>&1 | tee /homes/cx2/federated/results/train_cifar100_mxnet_cifarresnet_reg_fed_robust_impl3_1.log