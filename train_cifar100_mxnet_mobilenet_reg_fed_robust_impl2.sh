...
mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile python /homes/cx2/federated/robust_fedavg/train_cifar100_mxnet_mobilenet_reg_fed_robust_impl2.py --classes 10 --model default --nsplit 100 --batchsize 50 --lr 0.1 --lr-decay 1 --lr-decay-epoch 600 --regularization 0.8 --reg-inc 0.1 --reg-inc-epoch 6000 --epochs 800 --iterations 1 --dir /homes/cx2/datasets/cifar10_normalized -o $logfile 2>&1 | tee /homes/cx2/federated/results/train_cifar100_mxnet_default_reg_fed_robust_impl2.log