...
mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile python /homes/cx2/federated/fedrob/fedrob_bptt.py --model default --nsplit 100 --nbyz 0 --trim 0 --lr 20 --alpha 1 --alpha-decay 0.9 --alpha-decay-epoch 300 --epochs 400 --iterations 2 --seed 733 --dir $inputdir --valdir $valdir --log $logfile 2>&1 | tee $watchfile