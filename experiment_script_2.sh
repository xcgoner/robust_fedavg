...
# start training
mpirun -np 10 -machinefile $PBS_O_WORKDIR/hostfile python /homes/cx2/federated/robust_fedavg_momentum/train_cifar10_mxnet_fedrob_impl.py --classes 10 --model default --nsplit 100 --batchsize 50 --lr 0.1 --mmode "reset" --lr-decay 0.4 --lr-decay-epoch 400 --alpha 0.01 --epochs 800 --iterations 1 --seed 337 --dir $inputdir --valdir $valdir -o $logfile 2>&1 | tee $watchfile
